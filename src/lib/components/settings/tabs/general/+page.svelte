...
<div class="container mt-8 space-y-8">
	<h2 class="text-2xl font-bold mb-4">{$_('GeneralSettings.GeneralSettings')}</h2>
	{#if isLoading}
		...
		<form on:submit|preventDefault={handleSaveCompany}>
			<div class="my-4">
				<label class="block text-sm font-medium text-gray-700 mb-1"
					>{$_('GeneralSettings.Provider')}:</label
				>
				<Input
					type="text"
			...
			<div class="my-4">
				<label class="block text-sm font-medium text-gray-700 mb-1"
					>{$_('GeneralSettings.Description')}:</label
				>
				<Input
					type="text"
			...
			<div class="my-4">
				<label class="block text-sm font-medium text-gray-700 mb-1"
					>{$_('GeneralSettings.CompanyName')}:</label
				>
				<Input
					type="text"
			...
			<div class="mt-4 text-right">
				<Button type="submit" class="btn-primary text-white rounded-md px-4 py-2">
					{$_('GeneralSettings.SaveSettings')}
				</Button>
			</div>
		</form>
	{/if}
